...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @AvgJoeGui_OpeningFcn, ...
                   'gui_OutputFcn',  @AvgJoeGui_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
function AvgJoeGui_OpeningFcn(hObject, eventdata, handles, varargin)
...
set (handles.hp,'string',num2str(AHealth))
set (handles.attack,'string',num2str(AAttack))
set (handles.defense,'string',num2str(ADefense))
set (handles.accuracy,'string',num2str(AAccuracy))
set (handles.speed,'string',num2str(ASpeed))
...
function varargout = AvgJoeGui_OutputFcn(hObject, eventdata, handles) 
